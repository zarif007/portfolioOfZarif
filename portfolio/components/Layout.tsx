          ...
          <div className="mt-10">
            <div className="relative">
              <div
                ...
                className="cursor-pointer bottom-1 right-0 flex justify-center items-center space-x-1 z-10 my-6 mx-3 gradient1-bg text-gray-900 font-semibold px-3 py-1 rounded fixed"
              >
                <FiPlay />
                <p>Run Code</p>
              </div>
